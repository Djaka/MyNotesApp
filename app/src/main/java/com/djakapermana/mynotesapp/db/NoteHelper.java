...
import static com.djakapermana.mynotesapp.db.DatabaseContract.TABLE_NOTE;
...
public class NoteHelper {
    ...
    //Perintah untuk menghapus data disqLite
    public int delete(int id){
        int i = database.delete(TABLE_NOTE, _ID + " = '" + id + "'", null);
        return i;
    }
